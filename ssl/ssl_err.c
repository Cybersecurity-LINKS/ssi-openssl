...
static const ERR_STRING_DATA SSL_str_reasons[] = {
    ...
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_DID_METHOD_NOT_SUPPORTED),
    ...
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_INVALID_DID), "invalid did"},
    ...
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_NO_DID_DOCUMENT_RESOLVED),
    "no did document resolved"},
    ...
    {ERR_PACK(ERR_LIB_SSL, 0, SSL_R_NO_SHARED_DID_METHODS),
    "no shared did methods"},
